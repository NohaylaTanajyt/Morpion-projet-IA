...
int play(morpion jeu, int i, int j, char player, int size)
{
...
int winner (morpion jeu, char player, int size)
{
...
int max (morpion jeu, int size)
{
    ...
    if (winner(jeu, 1, size) == 1) return 10 ;
    else if (winner(jeu, 0, size) == 1)  return -10;
    else if (winner(jeu, 1, size) == -1) {
        return 0;
    }
    score = -10000 ; //-infini
    for (i = 0; i < size; i++) {
...
int min (morpion jeu, int size)
{
    ...
    else if (winner(jeu, 1, size) == -1) return 0;
